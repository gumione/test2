...
class TwForm extends Model {
    ...
    public function rules() {
        return [
            ...
            ['type', 'in', 'range' => array_keys(Order::typeLabelsTw())],
            ...
            [['link'], 'url'],
            [['link'], 'match',
                'pattern' => '/^https?:\/\/((www|mobile)\.)?twitter\.com\/(?:#!\/)?(\w+)((\/)|(\?\w+=\w+))?|https?:\/\/((www|mobile)\.)?twitter\.com\/(?:#!\/)?(\w+)\/status(es)?\/(\d+)(\?\w+=\w+)?\/?$/i',
                'message' => Yii::t('app', 'Please, enter Twitter URL')
            ],
    ...
    public function checkBalance() {
        ...
        $total += $prices['tw'][$this->type] / 1000;
